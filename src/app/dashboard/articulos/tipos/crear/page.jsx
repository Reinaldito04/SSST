...
function Page() {
  const breadcrumbs = [
    ...
    { label: "Articulos", link: "/dashboard/articulos" },
    { label: "Tipos de Articulos", link: "/dashboard/articulos/tipos" },
    { label: "Registrar nuevo tipo", link: "" },
  ];
        ...
        <div className="container-fluid mt-4">
          <div className="row  align-items-center">
            ...
            >
              ...
              />
              <h2 className="mb-0">Registrar Tipo </h2>
            </div>
          </div>
          <div
