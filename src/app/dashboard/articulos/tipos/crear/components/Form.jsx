...
function Form() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axioInstance.post("/article-types", {
        name: data.name,
        display_name: data.name.replace(/\s+/g, "_").toLowerCase(),
      ...
      let errorMessage = error.response?.data?.message || "Error al registrar el tipo";
      MySwal.fire({
        title: errorMessage,
        icon: "error",
        confirmButtonText: "OK",
