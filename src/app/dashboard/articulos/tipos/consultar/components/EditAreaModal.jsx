    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Error al actualizar el tipo de artículo. Por favor, intente nuevamente."
      );
    } finally {
      setLoading(false);
    }
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4 form-check form-switch">
                ...
                <small className="text-muted d-block mt-1">
                  {formData.active ? 
                    "(El Tipo está visible en el sistema)" : 
                    "(El Tipo está oculto en el sistema)"}
                </small>
              </div>
