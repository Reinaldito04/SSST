    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axioInstance.get(
          `/articles?page=${currentPage}&search_input=${searchTerm}`
        );
          ...
          {data.length > 0 ? (
            data.map((row) => (
              <tr key={row.id}>
                ...
                <td>{row.article_type_display_name	}</td>
                <td>
                  <HasPermission permissionName={"articles-edit"}>
                    <button
                  ...
                  <HasPermission permissionName={"articles-delete"}>
                    <button
      ...
      <div className="d-flex justify-content-between mt-2">
        ...
        <div className="d-flex gap-2">
          <CustomButton
            ...
            onClick={() => router.push("/dashboard/articulos/crear")}
          />
          <CustomButton
            label="Tipos de articulos"
            onClick={() => router.push("/dashboard/articulos/tipos/consultar")}
          />
        </div>
      </div>
