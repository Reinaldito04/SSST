...
function EditDepartmentModal({ isOpen, onRequestClose, department, onUpdate }) {
  ...
  React.useEffect(() => {
    setFormData({
      ...
      description: department?.description || "",
      active: department?.active,
      article_type_id: department?.article_type_id,
    });
  }, [department]);
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Error al actualizar el Articulo. Por favor, intente nuevamente."
      );
    } finally {
      setLoading(false);
    }
